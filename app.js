var express = require("express"), app = express(), formidable = require('formidable'), util = require('util'), fs = require('fs-extra'), qt = require('quickthumb');
// Use quickthumb
    ...
    form.on('end', function (fields, files) {
        ...
        fs.copy(temp_path, new_location + file_name, function (err) {
            if (err) {
                ...
                var slice_path = (new_location + file_name).slice(6);
